...
* Basic methods assume exchangeability of the data. 
  - Specialized methods for time series (see the modeltime package!).
...
* Extrapolating beyond training/calibration sets can go _really_ poorly.
...
ames_train <- training(ames_split)
ames_cal   <- validation(ames_split) # Use as calibration set
ames_test  <- testing(ames_split)
